...
import org.wordpress.android.databinding.MySiteNonTabbedFragmentBinding
...
class MySiteNonTabbedFragment : Fragment(R.layout.my_site_non_tabbed_fragment),
    ...
    private var binding: MySiteNonTabbedFragmentBinding? = null
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding = MySiteNonTabbedFragmentBinding.bind(view).apply {
            setupToolbar()
    ...
    private fun MySiteNonTabbedFragmentBinding.setupToolbar() {
    ...
    private fun MySiteNonTabbedFragmentBinding.setupContentViews(savedInstanceState: Bundle?) {
    ...
    @Suppress("LongMethod")
    private fun MySiteNonTabbedFragmentBinding.setupObservers() {
        ...
        viewModel.onTextInputDialogShown.observeEvent(viewLifecycleOwner, { model ->
            ...
            inputDialog.setTargetFragment(this@MySiteNonTabbedFragment, 0)
    ...
    private fun handleNavigationAction(action: SiteNavigationAction) = when (action) {
        ...
        is SiteNavigationAction.OpenMediaPicker ->
            mediaPickerLauncher.showSiteIconPicker(this@MySiteNonTabbedFragment, action.site)
        ...
        is SiteNavigationAction.StartWPComLoginForJetpackStats ->
            ActivityLauncher.loginForJetpackStats(this@MySiteNonTabbedFragment)
    ...
    private fun MySiteNonTabbedFragmentBinding.loadGravatar(avatarUrl: String) =
    ...
    private fun MySiteNonTabbedFragmentBinding.loadData(cardAndItems: List<MySiteCardAndItem>) {
    ...
    private fun MySiteNonTabbedFragmentBinding.loadEmptyView(shouldShowEmptyViewImage: Boolean) {
    ...
    companion object {
        ...
        fun newInstance(): MySiteNonTabbedFragment {
            return MySiteNonTabbedFragment()
        }
    }
    ...
    // TODO: ANNMARIE instanc tag is not needed
