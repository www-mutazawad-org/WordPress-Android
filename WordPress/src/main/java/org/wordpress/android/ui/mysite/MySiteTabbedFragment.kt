...
class MySiteTabbedFragment : Fragment(R.layout.my_site_tabbed_fragment),
    ...
    private fun MySiteTabbedFragmentBinding.setupContentViews(savedInstanceState: Bundle?) {
    ...
    private fun MySiteTabbedFragmentBinding.setupObservers() {
        ...
        viewModel.onTextInputDialogShown.observeEvent(viewLifecycleOwner, { model ->
            ...
            inputDialog.setTargetFragment(this@MySiteTabbedFragment, 0)
    ...
    private fun handleNavigationAction(action: SiteNavigationAction) = when (action) {
        ...
        is SiteNavigationAction.OpenMediaPicker ->
            mediaPickerLauncher.showSiteIconPicker(this@MySiteTabbedFragment, action.site)
        ...
        is SiteNavigationAction.StartWPComLoginForJetpackStats ->
            ActivityLauncher.loginForJetpackStats(this@MySiteTabbedFragment)
    ...
    private fun MySiteTabbedFragmentBinding.loadData(cardAndItems: List<MySiteCardAndItem>) {
    ...
    private fun MySiteTabbedFragmentBinding.loadEmptyView(shouldShowEmptyViewImage: Boolean) {
